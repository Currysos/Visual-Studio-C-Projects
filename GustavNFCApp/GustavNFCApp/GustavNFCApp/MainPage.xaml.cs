...
namespace GustavNFCApp
{
    public partial class MainPage : ContentPage
    {
        public const string ALERT_TITLE = "NFC";
        public const string MIME_TYPE = "application/com.currysoft.nfcapp";

        NFCNdefTypeFormat _type;
        readonly bool _makeReadOnly = false;
        ...
        private string _sendURI;

        void Entry_TextChanged(object sender, TextChangedEventArgs e)
        {
            _sendURI = ((Entry)sender).Text; // The text of the input field
        }
        ...
        async void Current_OnTagDiscovered(ITagInfo tagInfo, bool format)
        {
            ...
            try
            {
                ...
                record = new NFCNdefRecord
                {
                    ...
                    Payload = NFCUtils.EncodeToByteArray(_sendURI)
                };
                
                // Check format and record
                if (!format && record == null)
                    throw new Exception("Record can't be null.");

                // Add record to taginfo
